...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Lien', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '做一个geek，哪怕是最蹩脚的geek,只要是geek就好', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://lenotion-next.vercel.app/', // 网站地址
